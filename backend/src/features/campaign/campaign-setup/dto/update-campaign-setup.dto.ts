...
import { UpdateAddOnDTO } from 'src/features/campaign/add-ons/dto/update-add-on.dto';
import { UpdateCampaignDetailsDTO } from 'src/features/campaign/campaigns/dto/update-campaign-details.dto';
import { UpdateContractDTO } from 'src/features/campaign/contracts/dto/update-contract.dto';
import { CreateDeliverableDTO } from 'src/features/deliverable/deliverables/dto/create-deliverable.dto';
import { UpdateDeliverableDTO } from 'src/features/deliverable/deliverables/dto/update-deliverable.dto';
import { CreateGiftedProductDTO } from 'src/features/campaign/gifted-products/dto/create-gifted-product.dto';
import { UpdateGiftedProductDTO } from 'src/features/campaign/gifted-products/dto/update-gifted-product.dto';
