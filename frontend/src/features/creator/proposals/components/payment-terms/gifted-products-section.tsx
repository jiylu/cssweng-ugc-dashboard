    ...
    <div className="bg-white border border-border rounded p-5.5 flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-4">
        {giftedProducts.length === 0 ? (
          <p className="text-sm text-muted-foreground text-center py-1 italic">No gifted product listed.</p>
        ) : (
      ...
      <div className="flex justify-center mt-2">
        <Button
          variant="outline"
          onClick={onAdd}
          className="border-[#6b1fa8] text-[#6b1fa8] hover:bg-[#6b1fa8] hover:text-white rounded-[2px] p-5"
        >
          <Plus size={16} />
