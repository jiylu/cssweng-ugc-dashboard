  ...
  return (
    <Card className="flex flex-col gap-4 w-full">
      ...
      <div className="flex flex-col gap-2 mt-2">
        <h3 className="text-lg font-normal text-muted-foreground">Optional Extra Notes</h3>
        <Textarea
          value={extraNotes}
          ...
          className="min-h-[160px] resize-none border border-border rounded-[3px] -mt-1 text-sm bg-transparent placeholder:text-muted-foreground placeholder:italic"
        />
