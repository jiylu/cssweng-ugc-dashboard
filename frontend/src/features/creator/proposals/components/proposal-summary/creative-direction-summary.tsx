  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <ul className="flex flex-col gap-1 list-disc list-inside">
        ...
        <li className="text-xs text-muted-foreground">Revisions must be requested within <span className="text-[#6b1fa8]">{revisionDays} business days</span> of draft delivery.</li>
